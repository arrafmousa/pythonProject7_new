...
# # from ex22 import InfinitePirateAgent, ids, OptimalPirateAgent
...
import random
import networkx as nx
from ex2 import InfinitePirateAgent, PirateAgent
from aaaa import ids, OptimalPirateAgent
from additional_inputs import additional_inputs
from inputs import small_inputs
import logging
import time
...
class PirateStochasticProblem:
    ...
    def run_round(self):
        ...
        action_list = []
        if 'turns to go' not in self.state:
            print("infinite game - adding 1000 turns")
